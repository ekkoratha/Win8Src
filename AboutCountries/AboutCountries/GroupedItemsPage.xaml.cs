...
namespace AboutCountries
{
    ...
    /// </summary>
    public sealed partial class GroupedItemsPage : AboutCountries.Common.LayoutAwarePage
    {
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(GroupDetailPage), ((CountryDataGroup)group).UniqueId);
        }
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
            var itemId = ((CountryDataItem)e.ClickedItem).UniqueId;
